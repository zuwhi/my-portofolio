...
const Certificate = () => {
  ...
  return (
    <>
      <SEO
        title="Certificate"
        description="Sertifikat dan penghargaan Reihan Saputra — Best Graduate UNISNU, juara berbagai kompetisi software development, web programming, dan design tingkat nasional."
        url="/certificate"
      />

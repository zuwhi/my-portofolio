    ...
    <section className="w-full h-screen relative">
      ...
      <Canvas className={`w-full h-screen bg-transparent ${isRotating ? "cursor-grabbing" : "cursor-grab"}`} camera={{ near: 0.1, far: 1000 }}>
        <Suspense fallback={<Loader />}>
          ...
          {/* <Earth isRotating={isRotating} setIsRotating={setIsRotating} setCurrentStage={setCurrentStage} position={islandPosition} rotation={[0.1, 4.7077, 0]} scale={islandScale} /> */}
          ...
          <Plane isRotating={isRotating} position={biplanePosition} rotation={[0, 20.1, 0.2]} scale={biplaneScale} />
          {/* <Ship isRotating={isRotating} position={biplanePosition} rotation={[0, 20.1, 0]} scale={0.005} /> */}
        </Suspense>
      </Canvas>
